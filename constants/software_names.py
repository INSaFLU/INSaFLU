...
class SoftwareNames(object):
    ...
    SOFTWARE_Pangolin_name_search_name = (
        "Pango"  ## only yo help on the search of Pango Name in output
    )
    SOFTWARE_Pangolin_name = "Pangolin"  ## Pangolin
    SOFTWARE_Pangolin_learn_name_old = (
        "PangolinLearn"  ## was "PangolinLearn", now PangoLearn
    )
    ...
    SOFTWARE_Pangolin_name_extended = (
    ...
    SOFTWARE_MAFFT_PARAMETERS_TWO_SEQUENCES = (
        "--maxiterate 1000 --localpair --preservecase --leavegappyregion"
    )
    ...
    def get_pangolin_learn_name(self):
        return self.SOFTWARE_Pangolin_learn_name

    def get_pangolin_learn_name_old(self):
        return self.SOFTWARE_Pangolin_learn_name_old

    def get_pangolin_designation_name(self):
        return self.SOFTWARE_Pangolin_designation_name

    def get_pangolin_constellations_name(self):
        return self.SOFTWARE_Pangolin_constellations_name

    def get_pangolin_scorpio_name(self):
        return self.SOFTWARE_Pangolin_scorpio_name

    def get_pangolin_name_extended(self):
        return self.SOFTWARE_Pangolin_name_extended
    ...
    def get_pangolin_version(self, software):
        ...
        if software == SoftwareNames.SOFTWARE_Pangolin_learn_name:
            return self.get_pangolin_learn_version()
        if software == SoftwareNames.SOFTWARE_Pangolin_designation_name:
            return self.get_pangolin_designation_version()
        if software == SoftwareNames.SOFTWARE_Pangolin_scorpio_name:
            return self.get_pangolin_scorpio_version()
        if software == SoftwareNames.SOFTWARE_Pangolin_constellations_name:
            return self.get_pangolin_constellations_version()
        return ""

    def get_pangolin_learn_version(self):
        return self.SOFTWARE_Pangolin_learn_VERSION

    def get_pangolin_designation_version(self):
        return self.SOFTWARE_Pangolin_designation_VERSION

    def get_pangolin_scorpio_version(self):
        return self.SOFTWARE_Pangolin_scorpio_VERSION

    def get_pangolin_constellations_version(self):
        return self.SOFTWARE_Pangolin_constellations_VERSION
