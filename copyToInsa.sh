...
echo 'constants'
scp -P 2023 -r constants* insa@193.137.95.75:/usr/local/web_site
echo 'extend_user'
scp -P 2023 -r extend_user* insa@193.137.95.75:/usr/local/web_site
echo 'fluwebvirus'
scp -P 2023 -r fluwebvirus* insa@193.137.95.75:/usr/local/web_site
echo 'log_login'
scp -P 2023 -r log_login* insa@193.137.95.75:/usr/local/web_site
echo 'manage_virus'
scp -P 2023 -r manage_virus* insa@193.137.95.75:/usr/local/web_site
echo 'managing_files'
scp -P 2023 -r managing_files* insa@193.137.95.75:/usr/local/web_site
echo 'templates'
