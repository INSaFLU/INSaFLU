...
class Command(BaseCommand):
	'''
	classdocs
	Ex: python3 manage.py collect_global_dataset_files_for_update_metadata --dataset_id 11 --user_id 1
	...
	def handle(self, *args, **options):
		...
		try:
			...
			collect_extra_data.collect_update_extra_metadata_for_dataset(dataset, user)
