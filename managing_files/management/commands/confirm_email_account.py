...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--username", type=str, help="User name to activate email..."
        )
    ...
    def handle(self, *args, **options):
        ...
        if username == "last_account_created":
            ...
            try:
                ...
                self.stdout.write(
                    "Error: User login '{}' does not exist.".format(username)
                )
                return
        ...
        if is_email_active:
            self.stdout.write(
                "User name email '{}' is already confirmed.".format(username)
            )
        else:
            ...
            self.stdout.write("User software defaults are set.")
