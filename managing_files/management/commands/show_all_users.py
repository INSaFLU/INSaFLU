...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		self.stdout.write("Pk".ljust(10) + "Name".ljust(40) + "#projects".ljust(15) +  "Last access".ljust(20) + "Last IP".ljust(18) + "SuperUser".ljust(15) + "Active".ljust(10) + "Email Active".ljust(20))
		self.stdout.write("-" * (10 + 40 + 15 + 20 + 18 + 15 + 10 + 20))
