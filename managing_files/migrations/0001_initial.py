    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_subtype', models.CharField(blank=True, max_length=150, null=True, verbose_name='Classification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.ManyToManyField(to='managing_files.seasonreference')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('classification', models.CharField(blank=True, max_length=150, null=True, verbose_name='Classification')),
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='uploaded date')),
                ...
                ('sample', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_samples', to='managing_files.sample')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='Uploaded Date')),
                ('primer_fasta', fluwebvirus.formatChecker.ContentTypeRestrictedFileField(blank=True, max_length=500, null=True, upload_to=managing_files.models.primer_directory_path)),
                ...
                ('primer_pairs', fluwebvirus.formatChecker.ContentTypeRestrictedFileField(blank=True, max_length=500, null=True, upload_to=managing_files.models.primer_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meta_key_sample', to='managing_files.sample')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meta_key_project_sample', to='managing_files.projectsample')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meta_key_project', to='managing_files.project')),
            ],
            options={
                'ordering': ['project__id', '-creation_date'],
            },
