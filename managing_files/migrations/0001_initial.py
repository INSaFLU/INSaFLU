...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, default='New reference', max_length=200)),
        ...
        migrations.AddField(
            ...
            name='project_sample',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='count_variations', to='managing_files.ProjectSample'),
        ),
        migrations.AddIndex(
            model_name='reference',
