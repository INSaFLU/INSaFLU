...
urlpatterns = [
	...
	url(r'samples/(?P<pk>\d+)/show_sample_settings$', views.SampleSettingsView.as_view(), name='sample-settings'),
	...
	url(r'^ajax/show_coverage_as_a_table$', ajax_views.show_coverage_as_a_table, name='show-coverage-as-a-table'),
