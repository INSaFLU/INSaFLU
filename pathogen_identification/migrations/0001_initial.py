    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_db', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('bam_path', models.CharField(blank=True, max_length=200, null=True)),
                ('bai_path', models.CharField(blank=True, max_length=200, null=True)),
                ('reference_path', models.CharField(blank=True, max_length=200, null=True)),
                ('reference_index_path', models.CharField(blank=True, max_length=200, null=True)),
                ('reference_assembly_paf', models.CharField(blank=True, max_length=200, null=True)),
                ('mapped_scaffolds_path', models.CharField(blank=True, max_length=200, null=True)),
                ('mapped_scaffolds_index_path', models.CharField(blank=True, max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Projects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bam_file_path', models.CharField(blank=True, max_length=250, null=True)),
                ('bai_file_path', models.CharField(blank=True, max_length=250, null=True)),
                ('fasta_file_path', models.CharField(blank=True, max_length=250, null=True)),
                ('fai_file_path', models.CharField(blank=True, max_length=250, null=True)),
            ],
            options={
                'ordering': ['reference'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contig_classification_performed', models.BooleanField()),
                ('remap', models.CharField(blank=True, max_length=50, null=True)),
                ('remap_performed', models.BooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pathogen_identification.Sample')),
            ],
            options={
                'ordering': ['sample'],
            },
        ...
        migrations.AddField(
            ...
            name='sample',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pathogen_identification.Sample'),
        ),
        migrations.AddField(
            model_name='runmain',
            name='sample',
