    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contig_classification_report', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_path', models.CharField(blank=True, max_length=400, null=True)),
                ('reference_index_path', models.CharField(blank=True, max_length=400, null=True)),
                ('reference_assembly_paf', models.CharField(blank=True, max_length=400, null=True)),
                ('mapped_scaffolds_path', models.CharField(blank=True, max_length=400, null=True)),
                ('mapped_scaffolds_index_path', models.CharField(blank=True, max_length=400, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ParameterSet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('args', models.CharField(blank=True, max_length=250, null=True)),
                ('db', models.CharField(blank=True, max_length=250, null=True)),
                ('read_classification_report', models.CharField(blank=True, max_length=250, null=True)),
                ('classification_number', models.IntegerField(blank=True, null=True)),
                ('classification_minhit', models.IntegerField(blank=True, null=True)),
                ('success', models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bam_file_path', models.CharField(blank=True, max_length=350, null=True)),
                ('bai_file_path', models.CharField(blank=True, max_length=350, null=True)),
                ('fasta_file_path', models.CharField(blank=True, max_length=350, null=True)),
                ('fai_file_path', models.CharField(blank=True, max_length=350, null=True)),
                ('mapped_subset_r1', models.CharField(blank=True, max_length=350, null=True)),
                ('mapped_subset_r2', models.CharField(blank=True, max_length=350, null=True)),
            ],
            options={
                'ordering': ['reference'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merged_files', models.CharField(blank=True, max_length=300, null=True)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrichment_args', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('host_depletion_args', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.AddField(
            ...
            name='reference',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pathogen_identification.ReferenceMap_Main'),
        ),
        migrations.AddField(
            model_name='referencecontigs',
            name='run',
