...
class Test(unittest.TestCase):
	...
	def test_pangolin_file(self):
		...
		self.assertEqual("Alpha (B.1.1.7-like)", parse_pangolin_result.get_scorpio_call("MN908947_SARSCoVDec200153"))
		...
		self.assertEqual("Alpha1 (B.1.1.7-like)", parse_pangolin_result.get_scorpio_call("MN908947_SARSCoVDec200234"))
		...
		self.assertEqual("Alpha (B.1.1.7-like);Alpha1 (B.1.1.7-like)", parse_pangolin_result.get_scorpio_call("MN908947_SARSCoVDec20"))
		...
		self.assertEqual("", parse_pangolin_result.get_scorpio_call(None))
