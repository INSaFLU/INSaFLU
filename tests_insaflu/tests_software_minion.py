...
#		print(project_sample.get_file_output_human(TypePath.MEDIA_ROOT, FileType.FILE_TAB, SoftwareNames.SOFTWARE_Medaka_name))
		...
		self.assertEquals(31, count_hits.get_total())
		...
		self.assertEquals(31, project_sample.count_variations.var_bigger_90)
		...
		self.assertEquals("MSA Masker-1.0; (--c 9; for coverages less than 10 in 40% of the regions.)", result.get_software(self.software_names.get_msa_masker_name()))
		self.assertEquals("Medaka-1.2.0; (consensus -m r941_min_high_g360)/Medaka-1.2.0; (depth -aa -q 0)",\
		...
		self.assertEqual(coverage.get_coverage('MN908947', Coverage.COVERAGE_PROJECT), "63.1") ### in this case is equal to 9
