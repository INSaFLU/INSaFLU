...
class ParseOutFiles(object):
	...
	HEADER_TAB_FILE_WRITE = "ID	CHROM	POS	TYPE	REF	ALT	FREQ	FTYPE	STRAND	NT_POS	AA_POS	EFFECT	EFFECT.c	EFFECT.p	LOCUS_TAG	GENE	PRODUCT"
	HEADER_TAB_FILE_WRITE_snippy = "ID	CHROM	POS	TYPE	REF	ALT	EVIDENCE	FTYPE	STRAND	NT_POS	AA_POS	EFFECT	EFFECT.c	EFFECT.p	LOCUS_TAG	GENE	PRODUCT"
