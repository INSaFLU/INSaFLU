...
class Test(unittest.TestCase):
	...
	def test_coverage_2(self):
		...
		self.assertTrue(coverage.is_100_more_9('8'))
		self.assertEqual("Fail, element '8' has a ratio '100.0%' under of 100% for a coverage of 10 or bigger", coverage.get_fault_message_9('8'))
		self.assertEqual("Fail, element '8' has a ratio '100.0%' under of 100% for a coverage of 1 or bigger", coverage.get_fault_message_0('8'))
		self.assertEqual(coverage.get_coverage('1', Coverage.COVERAGE_MORE_0), "100.0")
